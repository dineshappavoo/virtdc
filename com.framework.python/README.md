...
* guestconfig.xml - dump XML (with replaceable keywords for future new VM’s) of the base VM which will be used to clone new VM’s
* references.txt - Maintains the referrences
