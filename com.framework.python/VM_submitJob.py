...
def main(argv):
	...
	cp_cmd = "scp node1:/var/lib/libvirt/images/Test.img"+image_dest
	...
	xmlstring=xmlstring.replace("image_path", image_dest);
    
	print xmlstring
    
	#command to clone the image
	clone="virsh --connect qemu+ssh://node3/system create ./node_info.xml"
	clone_out = subprocess.Popen(clone, shell=True, stderr=subprocess.PIPE)
